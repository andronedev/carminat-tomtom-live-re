...
**Tout le travail documenté ici a été effectué à partir de la carte SD personnelle de l'auteur (extraite du véhicule pour analyse) et du firmware officiel téléchargé depuis le CDN TomTom.**
...
> ⚠️ **Section non vérifiée par l'auteur** — les informations ci-dessous proviennent de l'analyse statique du firmware et de retours communautaires (forum gpspower.net). Aucun test UART physique n'a été effectué sur le boîtier. Les pads exacts, le baudrate et le comportement réel du shell restent à confirmer empiriquement.
...
> Hash extrait du firmware officiel `9.884.1609031_RC06.CAB-Dieppe.cab`, cracké avec john + rockyou.txt. Le mot de passe `palmtop1` est présent dans le firmware public mais sa validité runtime sur un boîtier réel n'a pas été testée par l'auteur.
